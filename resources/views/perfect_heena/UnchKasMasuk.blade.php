          ...
          <div class="container-fluid">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5><i data-feather="book-open"></i> Tambah Kas Masuk </h5><span>Form Tambah Kas Masuk</span>
                  </div>
                  <div class="card-body">
                  <form class="dropzone" id="singleFileUpload" action="/nota/upload">
                    ...
                    <form id="tambah_kas">
                      ...
                      <div class="col-md-12 mb-6">
                        ...
                        <input type="hidden" name="tipe" value="kas_masuk">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5><i data-feather="book-open"></i> List Kas Masuk</h5><span>Kas Masuk Per {{ date('F') }} {{ date('Y') }}</span>
                  </div>
                  <div class="card-body">
