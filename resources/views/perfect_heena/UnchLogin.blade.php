          ...
          <div class="login-card">
            <div>
              ...
              <div class="login-main"> 
                ...
                <form id="simba_login" class="theme-form">
                  <h4>Masuk dengan akun anda</h4>
                  <p>SIlahkan masukan username dan kata sandi anda!</p>
                  <div class="form-group">
                    <label class="col-form-label">Username</label>
                    <input class="form-control" type="text" name="username" required="" placeholder="heena">
                  </div>
                  <div class="form-group">
